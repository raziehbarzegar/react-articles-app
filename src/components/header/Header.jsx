    ...
    <header className="header pt-32">
      <div className="container px-4 md:px-24">
        <div className="flex flex-row items-center gap-10 mb-10">
          <div className="md:basis-1/2 mb-5 hidden md:block transition-transform hover:scale-95 duration-500">
            <img
              src={introImg}
          ...
          <div className="md:basis-1/2 flex flex-col gap-8 items-center">
